...
public class Main {
	...
	public static void main(String[] args) {
		List lista = new ArrayList(); //List precisa ser importado pois n�o � estatico.
		
		lista.add("abc"); //add a string, int e boolean a lista;
		lista.add(12);
		lista.add(true);
		
//		for (int x=0; x< lista.size(); x++) {//size = a lenght mede o tamanho sem precisar se preocupar em aumentar os c�lculos.
//			System.out.println(lista.get(x)); //get pega o que est� na lista			
//		}
...
//		}
//		System.out.println();
//		lista.remove(0); //remove o item da posições e reorganiza novamente 
//		for (Object valor : lista) { 
//			System.out.println(valor);
//		}		
//		System.out.println();
